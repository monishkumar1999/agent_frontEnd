...
const DescribesAgency = () => {
    ...
    const fetchDescribes = async () => {
        ...
        try {
            const response = await axios.get(`${server}/describeMaster/view`, {
    ...
    return (
        <div>
            <h1 className="text-xl font-bold mb-4">Agency Describe List</h1>
...
export default DescribesAgency;
