...
export const onSave = async (id, setLoading, editedData, setDescribes, setEditableRow, setError, token, describes) => {
    setLoading(true);
    try {
        const response = await axios.put(
            `${server}/serviceProvide/edit`,
            {
        ...
        toast.success("Describe updated successfully!");
